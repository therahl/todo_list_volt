...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-list.com'
  config.app_name = 'Volt_list'
  config.mailer.from = 'Volt_list <no-reply@volt-list.com>'
  ...
  #
  config.app_secret = '6V3mYTQfsBUTajgupL4wNx-UOIxWh720VST48SYTEj5OTtidtkYiRjMRF-thx2_V-EE'
